...
const a = true, b = "isSet", c = "booleanEquals", d = "error", e = "endpoint", f = "tree", g = "PartitionResult", h = "stringEquals", i = "sigv4", j = { [w]: true, "default": false, "type": "Boolean" }, k = { [w]: false, "type": "String" }, l = { [z]: "Endpoint" }, m = { [x]: c, [y]: [{ [z]: "UseFIPS" }, true] }, n = { [x]: c, [y]: [{ [z]: "UseDualStack" }, true] }, o = {}, p = { [x]: "getAttr", [y]: [{ [z]: g }, "name"] }, q = { [x]: c, [y]: [{ [z]: "UseFIPS" }, false] }, r = { [x]: c, [y]: [{ [z]: "UseDualStack" }, false] }, s = { [x]: "getAttr", [y]: [{ [z]: g }, "supportsFIPS"] }, t = { [x]: c, [y]: [true, { [x]: "getAttr", [y]: [{ [z]: g }, "supportsDualStack"] }] }, u = { "authSchemes": [{ "name": i, "signingRegion": "{PartitionResult#implicitGlobalRegion}" }] }, v = [{ [z]: "Region" }];
